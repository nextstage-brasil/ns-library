app.controller("UsuarioController", function ($rootScope, $scope, DataLoadService, $filter, $timeout, $compile) {
        ...
        $scope.UsuarioContextItens = [
            //{'link':'UsuarioOnClick(Usuario)', 'title': '<i class="fa fa-eye" aria-hidden="true"> </i> Ver'},
            {'link':'UsuarioOnEdit(Usuario)', 'title': '<i class="fa fa-edit" aria-hidden="true"> </i> Abrir'},
