...
class FinanceiroController extends AbstractController {
    ...
    private static $poderesGrupo = 'Financeiro';
    private static $poderesSubGrupo = 'Financeiro';
    ...
    public function __construct() {
        $this->ent = 'Financeiro';
        $this->camposDate = ['createtimeFinanceiro', 'vencimentoFinanceiro'];
        $this->camposDouble = [];
        $this->camposJson = ['extrasFinanceiro'];       
...
['default' => '', 'grid' => 'col-sm-4', 'type' => 'text', 'class' => '', 'ro' => 'false', 'tip' => '', 'label' => '']
    ...
    */
    public function ws_getAll($dados) {
        ...
        // IDs esperados
                foreach (['idFinanceiro','idMatricula','idStatus'] as $v) {
            if ((int) $dados[$v] > 0) {
