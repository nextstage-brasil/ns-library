 ...
 */
class MensagemGrupoController extends AbstractController {

    private static $poderesGrupo = 'MensagemGrupo';
    private static $poderesSubGrupo = 'MensagemGrupo';

    /**
     * @create 13/01/2020
     */
    public function __construct() {
        $this->ent = 'MensagemGrupo';
        $this->camposDate = ['createtimeMensagemGrupo'];
        $this->camposDouble = [];
        $this->camposJson = ['extrasMensagemGrupo'];
    ...
    public function ws_getAll($dados) {
        ...
        // IDs esperados
        foreach (['idMensagemGrupo', 'idUploadfile', 'idUsuario'] as $v) {
            if ((int) $dados[$v] > 0) {
