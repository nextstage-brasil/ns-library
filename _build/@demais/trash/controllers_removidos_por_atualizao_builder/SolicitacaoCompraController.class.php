...
class SolicitacaoCompraController extends AbstractController {

    private static $poderesGrupo = 'SolicitacaoCompra';
    private static $poderesSubGrupo = 'SolicitacaoCompra';
    ...
    */
    public function ws_getAll($dados) {
        ...
        // IDs esperados
                foreach (['idSolicitacaoCompra','idUsuario'] as $v) {
            if ((int) $dados[$v] > 0) {
