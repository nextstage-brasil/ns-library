...
class SharedController extends AbstractController {
    ...
    private static $poderesGrupo = 'Shared';
    private static $poderesSubGrupo = 'Shared';
    ...
    public function __construct() {
        $this->ent = 'Shared';
        $this->camposDate = ['createtimeShared'];
        $this->camposDouble = [];
        $this->camposJson = ['fieldShared'];       
