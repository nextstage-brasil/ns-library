...
/**
* 
* @date 2020-04-03T16:46:45-03:00
*/

class XGradeController extends AbstractController {

    private static $poderesGrupo = 'XGrade';
    private static $poderesSubGrupo = 'XGrade';
    ...
    public function __construct() {
        $this->ent = 'XGrade';
        $this->camposDate = ['createtimeGrade'];
        $this->camposDouble = [];
        $this->camposJson = ['extrasGrade'];       
...
['default' => '', 'grid' => 'col-sm-4', 'type' => 'text', 'class' => '', 'ro' => 'false', 'tip' => '', 'label' => '']
    ...
    */
    public function ws_getAll($dados) {
        ...
        // IDs esperados
                foreach (['idGrade','idModulo','idCurso'] as $v) {
            if ((int) $dados[$v] > 0) {
