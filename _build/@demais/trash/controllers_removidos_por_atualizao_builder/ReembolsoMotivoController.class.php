...
class ReembolsoMotivoController extends AbstractController {

    private static $poderesGrupo = 'ReembolsoMotivo';
    private static $poderesSubGrupo = 'ReembolsoMotivo';
    ...
    public function __construct() {
        $this->ent = 'ReembolsoMotivo';
        $this->camposDate = [];
        $this->camposDouble = [];
        $this->camposJson = ['extrasJson'];       
...
['default' => '', 'grid' => 'col-sm-4', 'type' => 'text', 'class' => '', 'ro' => 'false', 'tip' => '', 'label' => '']
    ...
    */
    public function ws_getAll($dados) {
        ...
        // IDs esperados
                foreach (['idReembolsoMotivo'] as $v) {
            if ((int) $dados[$v] > 0) {
