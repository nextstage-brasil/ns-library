...
class ReembolsoController extends AbstractController {
    ...
    private static $poderesGrupo = 'Reembolso';
    private static $poderesSubGrupo = 'Reembolso';
    ...
    public function __construct() {
        $this->ent = 'Reembolso';
        $this->camposDate = ['createtimeReembolso', 'dataPedidoReembolso', 'dataReferenciaReembolso', 'dataDecisaoReembolso', 'dataExecucaoReembolso'];
        $this->camposDouble = [];
        $this->camposJson = ['extrasReembolso'];       
...
['default' => '', 'grid' => 'col-sm-4', 'type' => 'text', 'class' => '', 'ro' => 'false', 'tip' => '', 'label' => '']
    ...
    */
    public function ws_getAll($dados) {
        ...
        // IDs esperados
                foreach (['idReembolso','idStatus','idReembolsoMotivo','idUsuario'] as $v) {
            if ((int) $dados[$v] > 0) {
