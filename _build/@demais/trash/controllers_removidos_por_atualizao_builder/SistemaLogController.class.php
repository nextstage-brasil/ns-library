...
class SistemaLogController extends AbstractController {

    private static $poderesGrupo = 'SistemaLog';
    private static $poderesSubGrupo = 'SistemaLog';
    ...
    public function __construct() {
        $this->ent = 'SistemaLog';
        $this->camposDate = ['createtimeLog'];
        $this->camposDouble = [];
        $this->camposJson = ['datasendLog'];       
