...
class LoginAttemptsController extends AbstractController {

    private static $poderesGrupo = 'LoginAttempts';
    private static $poderesSubGrupo = 'LoginAttempts';
    ...
    public function __construct() {
        $this->ent = 'LoginAttempts';
        $this->camposDate = ['createtimeLoginAttempts'];
        $this->camposDouble = [];
        $this->camposJson = ['geoLoginAttempts'];       
