...
class ForumController extends AbstractController {
    ...
    private static $poderesGrupo = 'Forum';
    private static $poderesSubGrupo = 'Forum';
    ...
    public function __construct() {
        $this->ent = 'Forum';
        $this->camposDate = ['createtimeForum', 'dataInicioForum', 'dataFimForum'];
        $this->camposDouble = [];
        $this->camposJson = ['moderadaoresForum'];       
...
['default' => '', 'grid' => 'col-sm-4', 'type' => 'text', 'class' => '', 'ro' => 'false', 'tip' => '', 'label' => '']
    ...
    */
    public function ws_getAll($dados) {
        ...
        // IDs esperados
                foreach (['idForum','idGradePolo','idUsuario'] as $v) {
            if ((int) $dados[$v] > 0) {
