...
class MensagemGrupoUsersController extends AbstractController {

    private static $poderesGrupo = 'MensagemGrupoUsers';
    private static $poderesSubGrupo = 'MensagemGrupoUsers';
    ...
    public function __construct() {
        $this->ent = 'MensagemGrupoUsers';
        $this->camposDate = ['createtimeMensagemGrupoUsers'];
        $this->camposDouble = [];
        $this->camposJson = ['extrasMsgGrupo'];       
...
['default' => '', 'grid' => 'col-sm-4', 'type' => 'text', 'class' => '', 'ro' => 'false', 'tip' => '', 'label' => '']
    ...
    */
    public function ws_getAll($dados) {
        ...
        // IDs esperados
                foreach (['idMsgGrupo','idMensagemGrupo','idUsuario'] as $v) {
            if ((int) $dados[$v] > 0) {
