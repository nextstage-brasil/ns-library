...
class SharedUserController extends AbstractController {

    private static $poderesGrupo = 'SharedUser';
    private static $poderesSubGrupo = 'SharedUser';
    ...
    public function __construct() {
        $this->ent = 'SharedUser';
        $this->camposDate = ['createtimeSharedUser'];
        $this->camposDouble = [];
        $this->camposJson = [];       
    ...
    */
    public function ws_getAll($dados) {
        ...
        // IDs esperados
                foreach (['idSharedUser','idShared','idUsuario'] as $v) {
            if ((int) $dados[$v] > 0) {
