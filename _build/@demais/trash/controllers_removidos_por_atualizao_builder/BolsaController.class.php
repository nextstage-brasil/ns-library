...
class BolsaController extends AbstractController {
    ...
    private static $poderesGrupo = 'Bolsa';
    private static $poderesSubGrupo = 'Bolsa';
    ...
    public function __construct() {
        $this->ent = 'Bolsa';
        $this->camposDate = ['createtimeBolsa', 'dataPedidoBolsa', 'dataDecisaoBolsa', 'validadeBolsa'];
        $this->camposDouble = [];
        $this->camposJson = ['extrasBolsa'];       
...
['default' => '', 'grid' => 'col-sm-4', 'type' => 'text', 'class' => '', 'ro' => 'false', 'tip' => '', 'label' => '']
    ...
    */
    public function ws_getAll($dados) {
        ...
        // IDs esperados
                foreach (['idBolsa','idMatricula','idStatus'] as $v) {
            if ((int) $dados[$v] > 0) {
