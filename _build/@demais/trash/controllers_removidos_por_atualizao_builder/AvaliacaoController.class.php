...
class AvaliacaoController extends AbstractController {
    ...
    private static $poderesGrupo = 'Avaliacao';
    private static $poderesSubGrupo = 'Avaliacao';
    ...
    public function __construct() {
        $this->ent = 'Avaliacao';
        $this->camposDate = ['createtimeAvaliacao', 'dataAvaliacao'];
        $this->camposDouble = [];
        $this->camposJson = ['extrasAvaliacao'];       
...
['default' => '', 'grid' => 'col-sm-4', 'type' => 'text', 'class' => '', 'ro' => 'false', 'tip' => '', 'label' => '']
    ...
    */
    public function ws_getAll($dados) {
        ...
        // IDs esperados
                foreach (['idAvaliacao','idModulo','idMatricula'] as $v) {
            if ((int) $dados[$v] > 0) {
