...
class GradeAlunoController extends AbstractController {

    private static $poderesGrupo = 'GradeAluno';
    private static $poderesSubGrupo = 'GradeAluno';
    ...
    public function __construct() {
        $this->ent = 'GradeAluno';
        $this->camposDate = ['createtimeGradeAluno'];
        $this->camposDouble = [];
        $this->camposJson = ['extrasGradeAluno'];       
...
['default' => '', 'grid' => 'col-sm-4', 'type' => 'text', 'class' => '', 'ro' => 'false', 'tip' => '', 'label' => '']
    ...
    */
    public function ws_getAll($dados) {
        ...
        // IDs esperados
                foreach (['idGradeAluno','idGradePolo','idMatricula'] as $v) {
            if ((int) $dados[$v] > 0) {
