...
class PostController extends AbstractController {
    ...
    private static $poderesGrupo = 'Post';
    private static $poderesSubGrupo = 'Post';
    ...
    public function __construct() {
        $this->ent = 'Post';
        $this->camposDate = ['createtimePost'];
        $this->camposDouble = [];
        $this->camposJson = ['extrasTexto'];       
