...
class LecionaController extends AbstractController {

    private static $poderesGrupo = 'Leciona';
    private static $poderesSubGrupo = 'Leciona';
    ...
    public function __construct() {
        $this->ent = 'Leciona';
        $this->camposDate = ['createtimeLeciona'];
        $this->camposDouble = [];
        $this->camposJson = [];       
    ...
    */
    public function ws_getAll($dados) {
        ...
        // IDs esperados
                foreach (['idLeciona','idModulo','idUsuario'] as $v) {
            if ((int) $dados[$v] > 0) {
