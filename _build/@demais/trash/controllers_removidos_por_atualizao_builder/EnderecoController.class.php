...
class EnderecoController extends AbstractController {
    ...
    private static $poderesGrupo = 'Endereco';
    private static $poderesSubGrupo = 'Endereco';
    ...
    public function __construct() {
        $this->ent = 'Endereco';
        $this->camposDate = ['createtimeEndereco'];
        $this->camposDouble = [];
        $this->camposJson = ['extrasEndereco'];       
...
['default' => '', 'grid' => 'col-sm-4', 'type' => 'text', 'class' => '', 'ro' => 'false', 'tip' => '', 'label' => '']
    ...
    */
    public function ws_getAll($dados) {
        ...
        // IDs esperados
                foreach (['idEndereco','idMunicipio'] as $v) {
            if ((int) $dados[$v] > 0) {
