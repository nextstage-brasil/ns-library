...
class EmpresaController extends AbstractController {
    ...
    private static $poderesGrupo = 'Empresa';
    private static $poderesSubGrupo = 'Empresa';
    ...
    public function __construct() {
        $this->ent = 'Empresa';
        $this->camposDate = ['createtimeEmpresa'];
        $this->camposDouble = [];
        $this->camposJson = ['extrasEmpresa', 'integracoesEmpresa', 'configEmpresa'];       
