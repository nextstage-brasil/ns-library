...
class SistemaFuncaoController extends AbstractController {

    private static $poderesGrupo = 'SistemaFuncao';
    private static $poderesSubGrupo = 'SistemaFuncao';
