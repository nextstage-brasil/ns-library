...
class Template {
     ...
     */
    public function __construct($template_file_or_html = false, $values = [], $openDelimiter = '{', $closeDelimiter = '}') {
        if (!$template_file_or_html) {
            $template_file_or_html = Config::getData('path') . '/view/template/000-template.html';
        }
