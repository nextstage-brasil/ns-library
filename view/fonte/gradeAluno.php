...
$GradeAlunos = [
            ...
            ['label' => Config::getAliasesField('isPresente'), 'atributo' => 'isPresenteF', 'class'=>'text-left'],

            ['label' => Config::getAliasesField('extrasGradeAluno'), 'atributo' => 'extrasGradeAluno', 'class'=>'text-left']
    ];
$GradeAlunos[0]['ngclick'] = $onclick;

// cards
$card = Card::basic($GradeAlunos, $entidade, false, $entidade.'ContextItens');

// table
foreach ($GradeAlunos as $campo) {
...
// Form
$form = [
Form::getModel(Html::inputSelectNgRepeat('GradeAluno.idGradePolo', Config::getAliasesField('idGradePolo'), 'GradeAluno.idGradePolo_ro', 'Aux.GradePolo', $ngClick, $ngChange), 'col-sm-4'), 
Form::getModel(Html::inputSelectNgRepeat('GradeAluno.idMatricula', Config::getAliasesField('idMatricula'), 'GradeAluno.idMatricula_ro', 'Aux.Matricula', $ngClick, $ngChange), 'col-sm-4'), 
Form::getModel(Html::inputSelectNgRepeat('GradeAluno.isPresente', Config::getAliasesField('isPresente'), 'GradeAluno.isPresente_ro', 'Aux.Boolean', $ngClick, $ngChange, 'Boolean'), 'col-sm-4'), 
Form::getModel('<config-json title="'.Config::getAliasesField('extrasGradeAluno').'" model="GradeAluno.extrasGradeAluno" grid="col-sm-6"></config-json>', 'col-sm-12')
];
