...
$Statuss = [
            ['label' => Config::getAliasesField('nomeStatus'), 'atributo' => 'nomeStatus', 'class'=>'text-left'],

            ['label' => Config::getAliasesField('entidadeStatus'), 'atributo' => 'entidadeStatus', 'class'=>'text-left'],

            ['label' => Config::getAliasesField('descricaoStatus'), 'atributo' => 'descricaoStatus', 'class'=>'text-left'],

            ['label' => Config::getAliasesField('colorStatus'), 'atributo' => 'colorStatus', 'class'=>'text-left']
    ];
$Statuss[0]['ngclick'] = $onclick;

// cards
$card = Card::basic($Statuss, $entidade, false, $entidade.'ContextItens');

// table
foreach ($Statuss as $campo) {
...
// Form
$form = [
Form::getModel(Html::input(['ng-model' => 'Status.nomeStatus', 'type'=>'text', 'class'=>'', 'required'=>'required ', 'ng-change' => $ngChange], Config::getAliasesField('nomeStatus')), 'col-sm-4'), 
Form::getModel(Html::input(['ng-model' => 'Status.entidadeStatus', 'type'=>'text', 'class'=>'', 'required'=>'required ', 'ng-change' => $ngChange], Config::getAliasesField('entidadeStatus')), 'col-sm-4'), 
Form::getModel(Html::input(['ng-model' => 'Status.descricaoStatus', 'type'=>'text', 'class'=>'', 'required'=>'not-required', 'ng-change' => $ngChange], Config::getAliasesField('descricaoStatus')), 'col-sm-4'), 
Form::getModel(Html::input(['ng-model' => 'Status.colorStatus', 'type'=>'text', 'class'=>'', 'required'=>'not-required', 'ng-change' => $ngChange], Config::getAliasesField('colorStatus')), 'col-sm-4')
];
