...
$Shareds = [
            ['label' => Config::getAliasesField('entidadeShared'), 'atributo' => 'entidadeShared', 'class'=>'text-left'],

            ['label' => Config::getAliasesField('valoridShared'), 'atributo' => 'valoridShared', 'class'=>'text-left'],

            ['label' => Config::getAliasesField('publicShared'), 'atributo' => 'publicSharedF', 'class'=>'text-left'],

            ['label' => Config::getAliasesField('writeShared'), 'atributo' => 'writeSharedF', 'class'=>'text-left'],

            ['label' => Config::getAliasesField('fieldShared'), 'atributo' => 'fieldShared', 'class'=>'text-left'],

            ['label' => Config::getAliasesField('nomeShared'), 'atributo' => 'nomeShared', 'class'=>'text-left']
    ];
$Shareds[0]['ngclick'] = $onclick;

// cards
$card = Card::basic($Shareds, $entidade, false, $entidade.'ContextItens');

// table
foreach ($Shareds as $campo) {
...
// Form
$form = [
Form::getModel(Html::input(['ng-model' => 'Shared.entidadeShared', 'type'=>'text', 'class'=>'', 'required'=>'required ', 'ng-change' => $ngChange], Config::getAliasesField('entidadeShared')), 'col-sm-4'), 
Form::getModel(Html::input(['ng-model' => 'Shared.valoridShared', 'type'=>'number', 'class'=>'', 'required'=>'required ', 'ng-change' => $ngChange], Config::getAliasesField('valoridShared')), 'col-sm-4'), 
Form::getModel(Html::inputSelectNgRepeat('Shared.publicShared', Config::getAliasesField('publicShared'), 'Shared.publicShared_ro', 'Aux.Boolean', $ngClick, $ngChange, 'Boolean'), 'col-sm-4'), 
Form::getModel(Html::inputSelectNgRepeat('Shared.writeShared', Config::getAliasesField('writeShared'), 'Shared.writeShared_ro', 'Aux.Boolean', $ngClick, $ngChange, 'Boolean'), 'col-sm-4'), 
Form::getModel('<config-json title="'.Config::getAliasesField('fieldShared').'" model="Shared.fieldShared" grid="col-sm-6"></config-json>', 'col-sm-12'), 
Form::getModel(Html::input(['ng-model' => 'Shared.nomeShared', 'type'=>'text', 'class'=>'', 'required'=>'required ', 'ng-change' => $ngChange], Config::getAliasesField('nomeShared')), 'col-sm-4')
];
