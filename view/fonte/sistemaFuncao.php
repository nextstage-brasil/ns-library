...
$SistemaFuncaos = [
            ['label' => Config::getAliasesField('acaoFuncao'), 'atributo' => 'acaoFuncao', 'class'=>'text-left'],

            ['label' => Config::getAliasesField('grupoFuncao'), 'atributo' => 'grupoFuncao', 'class'=>'text-left'],

            ['label' => Config::getAliasesField('subgrupoFuncao'), 'atributo' => 'subgrupoFuncao', 'class'=>'text-left']
    ];
$SistemaFuncaos[0]['ngclick'] = $onclick;

// cards
$card = Card::basic($SistemaFuncaos, $entidade, false, $entidade.'ContextItens');

// table
foreach ($SistemaFuncaos as $campo) {
...
// Form
$form = [
Form::getModel(Html::input(['ng-model' => 'SistemaFuncao.acaoFuncao', 'type'=>'text', 'class'=>'', 'required'=>'required ', 'ng-change' => $ngChange], Config::getAliasesField('acaoFuncao')), 'col-sm-4'), 
Form::getModel(Html::input(['ng-model' => 'SistemaFuncao.grupoFuncao', 'type'=>'text', 'class'=>'', 'required'=>'required ', 'ng-change' => $ngChange], Config::getAliasesField('grupoFuncao')), 'col-sm-4'), 
Form::getModel(Html::input(['ng-model' => 'SistemaFuncao.subgrupoFuncao', 'type'=>'text', 'class'=>'', 'required'=>'required ', 'ng-change' => $ngChange], Config::getAliasesField('subgrupoFuncao')), 'col-sm-4')
];
