...
$Paiss = [
            ['label' => Config::getAliasesField('nomePais'), 'atributo' => 'nomePais', 'class'=>'text-left'],

            ['label' => Config::getAliasesField('siglaPais'), 'atributo' => 'siglaPais', 'class'=>'text-left']
    ];
$Paiss[0]['ngclick'] = $onclick;

// cards
$card = Card::basic($Paiss, $entidade, false, $entidade.'ContextItens');

// table
foreach ($Paiss as $campo) {
...
// Form
$form = [
Form::getModel(Html::input(['ng-model' => 'Pais.nomePais', 'type'=>'text', 'class'=>'', 'required'=>'required ', 'ng-change' => $ngChange], Config::getAliasesField('nomePais')), 'col-sm-4'), 
Form::getModel(Html::input(['ng-model' => 'Pais.siglaPais', 'type'=>'text', 'class'=>'', 'required'=>'required ', 'ng-change' => $ngChange], Config::getAliasesField('siglaPais')), 'col-sm-4')
];
