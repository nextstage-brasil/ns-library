...
$Empresas = [
    ['label' => Config::getAliasesField('nomeEmpresa'), 'atributo' => 'nomeEmpresa', 'class' => 'text-left'],
    //['label' => Config::getAliasesField('extrasEmpresa'), 'atributo' => 'extrasEmpresa', 'class' => 'text-left'],
    //['label' => Config::getAliasesField('integracoesEmpresa'), 'atributo' => 'integracoesEmpresa', 'class' => 'text-left'],
    //['label' => Config::getAliasesField('configEmpresa'), 'atributo' => 'configEmpresa', 'class' => 'text-left']
];
$Empresas[0]['ngclick'] = $onclick;

// cards
$card = Card::basic($Empresas, $entidade, false, $entidade . 'ContextItens');

// table
foreach ($Empresas as $campo) {
...
// Form
$form = [
    Form::getModel(Html::input(['ng-model' => 'Empresa.nomeEmpresa', 'type' => 'text', 'class' => '', 'required' => 'required ', 'ng-change' => $ngChange], Config::getAliasesField('nomeEmpresa')), 'col-sm-4'),
    Form::getModel('<config-json title="' . Config::getAliasesField('extrasEmpresa') . '" model="Empresa.extrasEmpresa" grid="col-sm-6"></config-json>', 'col-sm-12'),
    //Form::getModel('<config-json title="' . Config::getAliasesField('integracoesEmpresa') . '" model="Empresa.integracoesEmpresa" grid="col-sm-6"></config-json>', 'col-sm-12'),
    //Form::getModel('<config-json title="' . Config::getAliasesField('configEmpresa') . '" model="Empresa.configEmpresa" grid="col-sm-6"></config-json>', 'col-sm-12')
];
