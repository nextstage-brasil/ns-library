...
$SolicitacaoCompras[0]['ngclick'] = $onclick;

// cards
$card = Card::basic($SolicitacaoCompras, $entidade, false, $entidade.'ContextItens');

// table
foreach ($SolicitacaoCompras as $campo) {
...
// Form
$form = [
Form::getModel(Html::inputSelectNgRepeat('SolicitacaoCompra.idUsuario', Config::getAliasesField('idUsuario'), 'SolicitacaoCompra.idUsuario_ro', 'Aux.Usuario', $ngClick, $ngChange), 'col-sm-4')
];
