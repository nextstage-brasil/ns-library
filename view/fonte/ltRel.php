...
$LtRels = [
            ['label' => Config::getAliasesField('nomeLtRel'), 'atributo' => 'nomeLtRel', 'class'=>'text-left']
    ];
$LtRels[0]['ngclick'] = $onclick;

// cards
$card = Card::basic($LtRels, $entidade, false, $entidade.'ContextItens');

// table
foreach ($LtRels as $campo) {
...
// Form
$form = [
Form::getModel(Html::input(['ng-model' => 'LtRel.nomeLtRel', 'type'=>'text', 'class'=>'', 'required'=>'required ', 'ng-change' => $ngChange], Config::getAliasesField('nomeLtRel')), 'col-sm-4')
];
