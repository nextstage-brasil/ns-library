<?php
// Automação de Criação de Sistema - 18/01/2021 05:20:48
...
$Escolaridades = [
            ['label' => Config::getAliasesField('nomeEscolaridade'), 'atributo' => 'nomeEscolaridade', 'class'=>'text-left'],

            ['label' => Config::getAliasesField('orderEscolaridade'), 'atributo' => 'orderEscolaridade', 'class'=>'text-left']
    ];
$Escolaridades[0]['ngclick'] = $onclick;

// cards
$card = Card::basic($Escolaridades, $entidade, false, $entidade.'ContextItens');

// table
foreach ($Escolaridades as $campo) {
...
// Form
$form = [
Form::getModel(Html::input(['ng-model' => 'Escolaridade.nomeEscolaridade', 'type'=>'text', 'class'=>'', 'required'=>'required ', 'ng-change' => $ngChange], Config::getAliasesField('nomeEscolaridade')), 'col-sm-4'), 
Form::getModel(Html::input(['ng-model' => 'Escolaridade.orderEscolaridade', 'type'=>'number', 'class'=>'', 'required'=>'not-required', 'ng-change' => $ngChange], Config::getAliasesField('orderEscolaridade')), 'col-sm-4')
];
